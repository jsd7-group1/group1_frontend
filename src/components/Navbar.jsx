  ...
  return (
    <>
        ...
        <div className="bg-transparent">
            ...
            <div
                className={`nav-links z-10 duration-500 absolute bg-[#f4f4f4] bg-opacity-80 md:bg-opacity-80 hover:bg-opacity-100 md:m-2 md:left-auto md:right-2 top-[-100%] left-3 right-3 md:w-[20%] w-full flex justify-center md:justify-end items-center p-8 rounded-xl drop-shadow-md ${
                menuOpen ? 'top-[11%]' : ''
                }`}
            >
            ...
            <div className="flex items-center gap-6">
                ...
                <Link to="/cart">
                <img src="../assets/images/navbar-icons/cart.png" alt="" className="nav_cart cursor-pointer h-7" />
                </Link>
