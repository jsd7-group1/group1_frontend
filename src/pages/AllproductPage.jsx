            ...
            <section className="flex flex-row gap-[10px] px-[10px] flex-wrap">
                ...
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/iceflatwhite.jpg" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                ...
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="w-full overflow-hidden rounded-md">
                      <img src="img/iceclassicchoc.jpg" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-1 flex flex-col text-[16px]">
                    ...
                    <div className="flex-1 text-[14px] text-[#979797]">
                      <span>
                        Chocolate sauce with milk and ice topped with whipped cream
                        and chocolate sauce.
                      </span>
                      <button className="block mt-5 text-[13px] font-bold rounded-[12px] bg-gray-100 w-[102px] h-[28px] text-[#00623B] hover:bg-[#DAC6B6]">
                        TYPE : COLD
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/maltydelight.jpg" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-1 flex flex-col text-[16px]">
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/mochafrap.png" className="block" />
                    </div>
                  </div>
                  {/*right*/}
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/americano.jpg" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/darkchoc.jpg" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/cafemocha.png" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/brewedcoffee.png" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/expressoconpana.png" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/caramelmacchiato.png" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/Yuzu-Cold-Brew.png" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/shot.png" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/strawberrytart.jpg" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/myrtillus cheese cake.png" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
                    ...
                    <div className="flex-1 text-[14px] text-[#979797]">
                      <span>
                        Creamy cheesecake swirled with tangy blueberry compote atop
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/prunus.jpg" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
                    ...
                    <div className="flex-1 text-[14px] text-[#979797]">
                      <span>
                        Flaky croissant filled with sweet almond paste, topped with
                        sliced almonds.
                      </span>
                      <button className="block mt-5 text-[13px] font-bold rounded-[12px] bg-gray-100 w-[102px] h-[28px] text-[#00623B] hover:bg-[#DAC6B6]">
                        BAKERY
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/softoatmilk.png" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
                    ...
                    <div className="flex-1 text-[14px] text-[#979797]">
                      <span>
                        Ristretto shot finished with A Chewy cookie with rolled oats
                        and Raisins
                      </span>
                      <button className="block mt-5 text-[13px] font-bold rounded-[12px] bg-gray-100 w-[102px] h-[28px] text-[#00623B] hover:bg-[#DAC6B6]">
                        BAKERY
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/custardcream.png" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
              ...
              <div className="w-full lg:w-[calc((100vw_-_30px)_/_2)] 2xl:w-[calc((100vw_-_60px)_/_3)]">
                <div className="flex bg-white hover:bg-[#efedea] p-3 gap-2 rounded-[18px] cursor-pointer h-full">
                  ...
                  <div className="max-w-[200px] max-h-[200px]">
                    <div className="h-full w-full overflow-hidden rounded-md">
                      <img src="img/Jumbo-Sausage.png" className="block" />
                    </div>
                  </div>
                  {/*right*/}
                  <div className="flex-[7] flex flex-col text-[16px]">
